...
#include "Parse3DO.h"
#include "Portfolio.h"
/* Vendored patch: bring ScreenContext into scope for the SwapScreens
 * prototype below. Original Toolkit 1.5 build chain relied on a
 * different transitive include order. */
...
/* Vendored patch: rename duplicate param names (original ARM SDT
 * tolerated this; modern armcc rejects). Binary interface unchanged
 * -- param names are slots, not part of the ABI. */
void CopyMatrix (mat33f16 srcMatrix, mat33f16 dstMatrix);
