...
static GraphicsOptions graphicsPresets[PRESET_OPTIONS_NUM] = {
	...
	{FRAME_LIMIT_2VBL, 3, WALL_QUALITY_HI, PLANE_QUALITY_HI, SCREEN_SCALE_2x1, false, DEPTH_SHADING_BRIGHT, false, RENDERER_DOOM},	// GBA
	{FRAME_LIMIT_2VBL, 4, WALL_QUALITY_HI, PLANE_QUALITY_HI, SCREEN_SCALE_2x1, false, DEPTH_SHADING_BRIGHT, false, RENDERER_DOOM},	// 32X
	{FRAME_LIMIT_3VBL, 5, WALL_QUALITY_HI, PLANE_QUALITY_HI, SCREEN_SCALE_2x1, true, DEPTH_SHADING_ON, true, RENDERER_DOOM},	// JAGUAR
